...
pub struct IMAGE_SECTION_HEADER {
    #[cfg_attr(
        feature = "serde",
        serde(serialize_with = "crate::wrap::sections::serialize_name")
    )]
...
#[cfg(feature = "serde")]
fn ser_fixed_file_info_struc_version<S: serde::Serializer>(
    &version: &u32,
    serializer: S,
) -> std::result::Result<S::Ok, S::Error> {
...
pub struct VS_FIXEDFILEINFO {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(serialize_with = "ser_fixed_file_info_struc_version")
    )]
