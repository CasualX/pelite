...
//! 		let view = pe32::PeView::from_bytes(&image)?;
//!
//! 		// Access the image contents
...
//!
//! Access the your own module with [`PeView::new`] to construct a view into your own image.
...
use self::image::*;
use self::pe_impl::{optional_header, validate_headers};

#[path = "../pe64/pe_impl.rs"]
mod pe_impl;
